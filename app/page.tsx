...
const PERSONAL_PROJECTS_DATA = [
  ...
  { title: "JEJAK", org: "ASEAN GeoAI Fusion 2026 · Hackathon", period: "2026", role: "Contributor", desc: "React Native (Expo) hiking safety app that predicts communication dead zones along trails, lets hikers download offline trail packs, and records GPS trajectories in the background so SAR teams get a real last-known location once coverage returns.", highlights: ["Predictive dead-zone warnings (gated)","Offline trail packs & maps","Background GPS recording","Retry-safe sync with backoff","86 automated tests, CI-gated","Honest route_only/fixture/model_backed staging"], tags: ["React Native","Expo","GeoAI","Search & Rescue"], icon: "🧭", accent: "#0d9488", accentRaw: "13,148,136", status: "Hackathon", statusColor: "#0d9488", href: "/projects/jejak" },
];

const COMPETITIONS_DATA = [
  { title: "JEJAK", event: "ASEAN GeoAI Fusion 2026", org: "GeoAI-Powered Hiking Safety App — React Native & Expo", period: "2026", role: "Contributor", desc: "React Native (Expo) hiking safety app that predicts communication dead zones along trails, lets hikers download offline trail packs, and records GPS trajectories in the background so SAR teams get a real last-known location once coverage returns.", tags: ["React Native", "Expo", "GeoAI", "Search & Rescue"], icon: "🧭", accent: "#d97706", accentRaw: "217,119,6", href: "/projects/jejak" },
];
                ...
                <div style={{ display: "flex", alignItems: "flex-start", gap: 12, marginBottom: 12 }}>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
                      ...
                      {(p as typeof p & { internal?: boolean }).internal && (
                        <span style={{ display: "inline-flex", alignItems: "center", gap: 4, fontSize: 10, padding: "2px 8px", borderRadius: 999, background: "rgba(107,114,128,.09)", border: "1px solid rgba(107,114,128,.22)", color: "#6b7280", fontWeight: 600 }}>
                          🔒 Internal Use
                        </span>
                      )}
                    </div>
                  ...
                  <tr ref={el => { rowRefs.current[i] = el; }} className={`o-row ${isOpen ? "open-row" : ""}`} onMouseEnter={() => setHovIdx(i)} onMouseLeave={() => setHovIdx(null)} onClick={() => toggle(i)}>
                    ...
                    <td style={{ padding: "18px 14px", background: rowBg, borderBottom: bdClr }}>
                      <div style={{ display: "flex", flexDirection: "column", gap: 4, alignItems: "flex-start" }}>
                        ...
                        {(p as typeof p & { internal?: boolean }).internal && (
                          <span style={{ display: "inline-flex", alignItems: "center", gap: 4, fontSize: 9.5, padding: "2px 8px", borderRadius: 999, background: "rgba(107,114,128,.09)", border: "1px solid rgba(107,114,128,.22)", color: "#6b7280", fontWeight: 600, whiteSpace: "nowrap" }}>
                            🔒 Internal Use
                          </span>
                        )}
                      </div>
